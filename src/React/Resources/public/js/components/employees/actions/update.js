...
export function retrieveError(retrieveError) {
  return {type: 'EMPLOYEE_UPDATE_RETRIEVE_ERROR', retrieveError};
}

export function retrieveLoading(retrieveLoading) {
  return {type: 'EMPLOYEE_UPDATE_RETRIEVE_LOADING', retrieveLoading};
}

export function retrieveSuccess(retrieved) {
  return {type: 'EMPLOYEE_UPDATE_RETRIEVE_SUCCESS', retrieved};
}
...
export function updateError(updateError) {
  return {type: 'EMPLOYEE_UPDATE_UPDATE_ERROR', updateError};
}

export function updateLoading(updateLoading) {
  return {type: 'EMPLOYEE_UPDATE_UPDATE_LOADING', updateLoading};
}

export function updateSuccess(updated) {
  return {type: 'EMPLOYEE_UPDATE_UPDATE_SUCCESS', updated};
}
...
export function update(item, values) {
  return (dispatch) => {
    ...
    delete values['login'];
    return fetch('/employees/'+item['id'], {
        method: 'PUT',
        headers: new Headers({
...
export function reset() {
  return {type: 'EMPLOYEE_UPDATE_RESET'};
}
